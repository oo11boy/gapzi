  ...
  return (
    <AnimatePresence>
      ...
      <motion.div
        ...
        onClick={handleBack} // بستن با کلیک بیرون
      />
          {/* مودال چت موبایل */}
          <motion.div
            initial={{ opacity: 0, x: "-100%" }} // باز شدن از چپ
            animate={{ opacity: 1, x: 0 }}
            exit={{ opacity: 0, x: "-100%" }} // بسته شدن هم به چپ برگردد
          ...
          >
            ...
            >
              ...
              <div
                ...
                onClick={() => showActions && setShowActions(null)}
              >
                    ...
                    messages.map((msg, i) => {
                      ...
                      return (
                        <motion.div
                          ...
                          onTouchStart={() =>
                            isSender && handleLongPress(msg.message_id)
                          }
